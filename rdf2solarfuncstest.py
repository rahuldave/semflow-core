...
#        thedict['datatypes_s']=[]
    ...
    if othersbool.has_key('bib') and othersbool['bib']==True:
        ...
        #print "+++++", thedict
        #print '=====', daprops
        thedict['numpubs_i']=len(papersray)
...
if __name__=="__main__":
    ...
    if datype=='bib':
        ...
        researchpapers=[ele.strip() for ele in dafile.split(',')]
        ...
        if mission.lower()=='chandra':
            ...
            obsuris=[prelim+ele.strip() for ele in dafile.split(',')]
        else:
